...
char* indexes(const char* path)
{
    ...
    else if(access("index.html", F_OK) == 0 ) 
    {
...
const char* lookup(const char* path)
{
    ...
    ans[j] = '\0';
    if(strcasecmp(ans,"css")==0)
    {
        return "text/css";
    }
    if(strcasecmp(ans,"html")==0)
    {
        return "text/html";
    }
    if(strcasecmp(ans,"gif")==0)
    {
        return "image/gif";
    }
    if(strcasecmp(ans,"ico")==0)
    {
        return "image/x-icon";
    }
    if(strcasecmp(ans,"jpg")==0)
    {
        return "image/jpeg";
    }
    if(strcasecmp(ans,"js")==0)
    {
        return "text/javascript";
    }
    if(strcasecmp(ans,"php")==0)
    {
        return "text/x-php";
    }
    if(strcasecmp(ans,"php")==0)
...
{
    int j = 0;
    char method[100],rt[strlen(line)] ,ans[strlen(line)+1];
    strcpy(ans,line);
    ans[strlen(line)]='\0';
    while(ans[j] != ' ' && j<99)
    {
